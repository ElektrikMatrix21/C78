...
import { KeyboardAvoidingView, View, StyleSheet, Text, Image, TouchableOpacity, TextInput, Alert, ScrollView, Modal } from 'react-native';
...
export default class WelcomeScreen extends Component {
  ...
  userSignUp = (emailId, password, confirmPassword) =>{
    if(password !== confirmPassword){
      return(
        Alert.alert("Password does not match/ check your password!")
      )
    }
    else{
...
const styles = StyleSheet.create({ 
  ...
  modalContainer:{ flex:1, borderRadius:20, justifyContent:'center', alignItems:'center', 
